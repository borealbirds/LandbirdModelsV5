...
# recalculate with consideration of bootstraps with missing variables
...
saveRDS(covariate_importance_zeroed, file="C:/Users/mannf/Proton Drive/mannfredboehm/My files/Drive/boreal_avian_modelling_project/NationalModelsv5/v4/covariate_interactions/rds_files/02_covariate_importance_zeroed.rds")
write_csv(covariate_importance_zeroed, file="G:/Shared drives/BAM_NationalModels4/NationalModels4.0/Manuscript/variable importance/BAM_RelativeImportance.csv")
...
# this loop creates a nested list of `data.frame`s of predictions generated by `plot.gbm`
